...
NOTES = {"rei": "needs cloth-config built for 1.21.1 next to the instance's 26.2 build; Fabric rejects the dependency before either tool runs",
  ...
  "visual-workbench": "puzzleslib's sound mixin captures a local that 26.2 no longer has at that point (same as cut-through); its render-context, pack-metadata and networking calls now bridge",
