...
auto-porter, 1.3.0-snapshot.10) and Fox-Grade: **Fox-Grade boots 64, Retromod boots 37.**
29 boot only under Fox-Grade, 2 only under Retromod, 35 under both, 38 under neither.
...
last verdict wins): **80 port and boot into a world** — six of them also verified on a dedicated
server, Mod Menu's mod list opens and renders through the GUI bridges, Lighty boots on the
re-created world-render events — and 50 do not. The failures are the 26.2 rewrites a bytecode port cannot paper over: renderer-tier
