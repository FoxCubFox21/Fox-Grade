...
auto-porter, 1.3.0-snapshot.10) and Fox-Grade: **Fox-Grade boots 66, Retromod boots 37.**
29 boot only under Fox-Grade, 0 only under Retromod, 37 under both, 38 under neither.
...
last verdict wins): **82 port and boot into a world** — six of them also verified on a dedicated
server, Mod Menu's mod list opens and renders through the GUI bridges, Lighty boots on the
re-created world-render events — and 48 do not. The failures are the 26.2 rewrites a bytecode port cannot paper over: renderer-tier
